...
const App = () => {
  ...
  const handleGameStart = () => {
    if (gameOptions.category === '' || gameOptions.difficulty === '' || gameOptions.type === '') setChooseIt(true)
    ...
    <main>
      <img className="shape-top" src='./shape-top.png' alt="Shape Top" />
      {
        ...
        <section className='game--intro'>
          ...
          {	noQuestions &&
            <h4>
              <br />Unfortunately there's no any questions with these options! Sorry :(
            </h4>
          }
          {chooseIt &&
            <h4>
              <br />Please select Category, Difficulty and Type!
            </h4>
          }
          ...
          <button className='main--button' onClick={handleGameStart}>Start Quiz</button>
